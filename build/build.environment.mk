...
# Gtk.Extra
REF_GTK_EXTRA = $(LINK_SYSTEM) $(LINK_GTK)
LINK_GTK_EXTRA = -r:$(DIR_BIN)/Gtk.Extra.dll
LINK_GTK_EXTRA_DEPS = $(REF_GTK_EXTRA) $(LINK_GTK_EXTRA)
...
REF_NEREID = $(LINK_BANSHEE_THICKCLIENT_DEPS) $(LINK_GTK_EXTRA_DEPS)
